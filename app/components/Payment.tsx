...
function CustomPaymentForm({ amount, closeModal }: { amount: number; closeModal: () => void }) {
    ...
    return (
        <>
            ...
            >
                <InViewWrapper className="border-animate border-top py-5" style={{ '--border-color': '#5e5e5e' }}>
