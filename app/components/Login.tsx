...
function Login({ closeModal }: { closeModal: () => void }) {
    ...
    return (
        <div className=" flex  flex-col z-30">
            <h1 className="text-4xl font-bold text-center">{type === 'login' ? 'Log In' : 'Sign Up'}</h1>
            ...
            {!loginWithEmail && (
                <div>
                    <button onClick={handleGoogleLogin} className="flex items-center justify-between bg-white py-3 px-4 w-full text-black mt-5">
                    ...
                    <button className="flex items-center justify-between bg-[#1878f2] mt-4 py-3 px-4 w-full text-white">
                        <svg width="24px" height="24px" viewBox="126.445 2.281 589 589" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button onClick={() => setLoginWithEmail(true)} className="py-3  w-full border border-[#d9d9d9] text-center">
            ...
            {loginWithEmail && (
                <div>
                    <form className="  mt-4" onSubmit={handleLogin}>
                        ...
                        <Link href="#" className="text-sm underline underline-offset-2 mt-6">
                            Forgot Password?
                        </Link>
                        <button
                            disabled={loading}
                            type="submit"
                            className={`mt-5 w-full py-3 bg-primary text-black ${loading ? 'animate-pulse' : ''}`}
                        >
                    ...
                    <div className="border-b border-white h-[11px] text-center w-full my-7">
                        <span className="bg-black px-3">or {type === 'login' ? 'log in' : 'sign up'} with</span>
                    </div>
                    ...
                    <div className="flex items-center justify-center gap-10">
                        ...
                        <button>
                            <svg width="30px" height="30px" viewBox="126.445 2.281 589 589" xmlns="http://www.w3.org/2000/svg">
                                <circle cx="420.945" cy="296.781" r="294.5" fill="#3c5a9a" />
                                <path
                                    d="M516.704 92.677h-65.239c-38.715 0-81.777 16.283-81.777 72.402.189 19.554 0 38.281 0 59.357H324.9v71.271h46.174v205.177h84.847V294.353h56.002l5.067-70.117h-62.531s.14-31.191 0-40.249c0-22.177 23.076-20.907 24.464-20.907 10.981 0 32.332.032 37.813 0V92.677h-.032z"
                                    fill="#ffffff"
