            ...
            <InViewWrapper className="animate-fadeIn md:relative md:pb-2 border-animate md:border-bottom">
                <nav className="relative z-20 flex items-center justify-between md:px-4">
                    ...
                    <div className="md:flex items-center gap-4 sm:text-sm lg:text-base lg:gap-8 hidden ">
                        ...
                        <Link href={'/blog'} className={`${currentPath === '/blog' ? 'text-[#EFFE8A]' : 'text-white hover:text-[#effe8a]'}`}>
                            Blog
                        </Link>
                    ...
                    <div
                        className={`${menu ? 'block' : 'hidden'} md:hidden overflow-hidden absolute top-0 left-0 bg-black text-white w-full h-screen`}
                    >
                        <div className="flex flex-col items-center pt-28 relative h-full w-full">
                            <svg
                                ...
                                viewBox="0 0 24 24"
                                fill="currentColor"
                                className="size-10 absolute top-10 right-3"
                            >
                                <path
                                    fillRule="evenodd"
                            ...
                            <div className="flex mt-10 flex-col items-center justify-center gap-5">
                                <Link href={'/'} className={`${currentPath === '/' && 'text-[#EFFE8A]'} font-semibold text-2xl`}>
                                    Home
                                </Link>
                                <Link href={'/blog'} className="font-semibold text-2xl">
                                    Blog
                                </Link>
                                <Link href={'/bookings'} className="font-semibold text-2xl">
                                    Book Online
                                </Link>
                                <Link href={'/pricing'} className="font-semibold text-2xl">
                                    Plans & Pricing
                                </Link>
                            </div>
                        </div>
